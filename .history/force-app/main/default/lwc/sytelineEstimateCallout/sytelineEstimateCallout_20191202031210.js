...
export default class SytelineEstimateCallout extends LightningElement {
    ...
    @track oppAccountValid;
    @track oppContactValid;
    ...
    connectedCallback(){
        ...
        checkEstimateExists({oppId: this.recordId})
            ...
            .then(result => {
                ...
                this.oppAccountValid = result;
                this.error = undefined;
            })
            .catch(error => {
                this.error = error;
                this.oppAccountValid = undefined;
            });
            validateOppContact({oppId : this.recordId})
            .then(result => {
                console.log('Is Opp Contact Valid? ' + result);
                this.oppContactValid = result;
                this.error = undefined;
            })
            .catch(error => {
                this.error = error;
                this.oppContactValid = undefined;
            });
    }    
